...
/* harmony export */   "newfetchRequest": () => (/* binding */ newfetchRequest)
/* harmony export */ });
/* harmony import */ var _deleteModal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./deleteModal */ "./src/modules/deleteModal.js");
/* harmony import */ var _modalControl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modalControl */ "./src/modules/modalControl.js");
// const url = 'http://localhost:3000/api/goods/';


const fetchRequest = async (url, _ref) => {
  let {
    method = 'GET',
    callback,
    body,
  ...
  try {
    ...
    if (response.status === 422 || response.status === 404 || response.status > 500) {
      const warning = (0,_deleteModal__WEBPACK_IMPORTED_MODULE_0__.modalMessage)();
      const h2 = warning.querySelector('.modal__text_message');
      h2.textContent = `Ошибка ${response.status}: ${response.statusText}`;
      warning.append(h2);
      const overlay = (0,_modalControl__WEBPACK_IMPORTED_MODULE_1__.getOverlay)();
      overlay.append(warning);
    } else if (response.statusText !== 200 || response.status !== 201 || response.status !== 422 || response.status !== 404 && response.status < 500) {
      const warning = (0,_deleteModal__WEBPACK_IMPORTED_MODULE_0__.modalMessage)();
      const h2 = warning.querySelector('.modal__text_message');
...
const newfetchRequest = async (postfix, _ref2) => {
  let {
    method = 'GET',
    callback,
    body,
...
/* harmony export */   "getCrmTotalPrice": () => (/* binding */ getCrmTotalPrice),
/* harmony export */   "getTableBody": () => (/* binding */ getTableBody),
/* harmony export */   "getTableRow": () => (/* binding */ getTableRow),
/* harmony export */   "setTotalPrice": () => (/* binding */ setTotalPrice)
/* harmony export */ });
const getCrmTotalPrice = () => {
...
const createRow = obj => {
  ...
  tableCellIdNumber.classList.add('table__cell', 'table__cell_number');
  const id = obj.id;
  ...
  tableCellName.classList.add('table__cell', 'table__cell_left', 'table__cell_name');
...
/* harmony export */   "getDiscountCount": () => (/* binding */ getDiscountCount),
...
const clickAddImage = () => {
  ...
  file.insertAdjacentHTML('beforebegin', `<p class="visually-hidden modal__texts">
...
const editModal = async (err, data) => {
  ...
  formChange.total.textContent = formChange.total.textContent = Number(formChange.price.value) * formChange.count.value;
  formChange.price.addEventListener('change', () => {
    formChange.total.textContent = Number(formChange.price.value) * formChange.count.value;
  });
  ...
  return new Promise(resolve => {
    ...
    formChange.addEventListener('submit', async e => {
      ...
      newObj.id = data.id;
      await (0,_fetch__WEBPACK_IMPORTED_MODULE_0__.fetchRequest)(`http://localhost:3000/api/goods/${newObj.id}`, {
        method: 'PATCH',
        body: {
          title: newObj.title,
...
/* harmony export */ });
/* harmony import */ var _fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fetch */ "./src/modules/fetch.js");
/* harmony import */ var _getElements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getElements */ "./src/modules/getElements.js");
...
const showSearch = async () => {
  const tableBody = (0,_getElements__WEBPACK_IMPORTED_MODULE_1__.getTableBody)();
  const search = await (0,_fetch__WEBPACK_IMPORTED_MODULE_0__.newfetchRequest)(`${inputSearch.value}`, {
    method: 'get'
  });
  ...
  const crmTotalPrice = (0,_getElements__WEBPACK_IMPORTED_MODULE_1__.getCrmTotalPrice)();
  crmTotalPrice.textContent = '0';
  search.forEach(item => {
    const tableRows = (0,_getElements__WEBPACK_IMPORTED_MODULE_1__.createRow)(item);
...
/* harmony export */ });
/* harmony import */ var _modules_getElements_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/getElements.js */ "./src/modules/getElements.js");
/* harmony import */ var _modules_modalControl_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/modalControl.js */ "./src/modules/modalControl.js");
/* harmony import */ var _modules_deleteModal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/deleteModal.js */ "./src/modules/deleteModal.js");
/* harmony import */ var _modules_fetch_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/fetch.js */ "./src/modules/fetch.js");
/* harmony import */ var _modules_modalEdit_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modalEdit.js */ "./src/modules/modalEdit.js");
...
const renderGoods = async () => {
  ...
  const tableBody = (0,_modules_getElements_js__WEBPACK_IMPORTED_MODULE_0__.getTableBody)();

  for (let i = 0; i < mass.length; i++) {
    const tableRows = (0,_modules_getElements_js__WEBPACK_IMPORTED_MODULE_0__.createRow)(mass[i]);
    tableRows.classList.add('table__row');
    tableBody.append(tableRows);
  }

  tableBody.addEventListener('click', async _ref => {
    let {
      target
    } = _ref;
    ...
    if (target.closest('.table__btn_pic')) {
      ...
      const btnPicUrl = target.closest('.table__btn_pic').getAttribute('data-pic');
      console.log(btnPicUrl);
      open(`http://localhost:3000/${btnPicUrl}`, '', `left=${left},top=${top},width=800,height=600`);
    }
  });
};
...
const editControl = () => {
  const tableBody = (0,_modules_getElements_js__WEBPACK_IMPORTED_MODULE_0__.getTableBody)();
  tableBody.addEventListener('click', async _ref2 => {
    let {
      target
    } = _ref2;
    ...
    if (target.closest('.table__btn_edit')) {
      ...
      const result = await (0,_modules_fetch_js__WEBPACK_IMPORTED_MODULE_3__.fetchRequest)(`http://localhost:3000/api/goods/${editId}`, {
        callback: _modules_modalEdit_js__WEBPACK_IMPORTED_MODULE_4__.editModal
      });
      ...
      if (result) {
        ...
        const crmTotalPrice = (0,_modules_getElements_js__WEBPACK_IMPORTED_MODULE_0__.getCrmTotalPrice)();
        crmTotalPrice.textContent = '0';
        renderGoods();
      }
    }
...
const delControl = () => {
  const tableBody = (0,_modules_getElements_js__WEBPACK_IMPORTED_MODULE_0__.getTableBody)();
  tableBody.addEventListener('click', async _ref3 => {
    let {
      target
    } = _ref3;
    ...
    if (target.closest('.table__btn_del')) {
      ...
      const delCost = Number(rowDel.querySelector('.table__cell-total').textContent.slice(1));
      const b = rowDel.querySelector('.table__cell_number').textContent;
      const checkDelete = await (0,_modules_fetch_js__WEBPACK_IMPORTED_MODULE_3__.fetchRequest)(`http://localhost:3000/api/goods/${b}`, {
        callback: _modules_deleteModal_js__WEBPACK_IMPORTED_MODULE_2__.deleteModal
      });
      ...
      if (checkDelete) {
        ...
        const crmTotalPrice = (0,_modules_getElements_js__WEBPACK_IMPORTED_MODULE_0__.getCrmTotalPrice)();
        crmTotalPrice.textContent = Number(crmTotalPrice.textContent) - delCost;
      }
    }
  });
};
...
const formControl = (form, tableBody, closeModal) => {
  form.addEventListener('submit', async e => {
    e.preventDefault();
    const overlay = (0,_modules_modalControl_js__WEBPACK_IMPORTED_MODULE_1__.getOverlay)();
    const formData = new FormData(e.target);
    const newObj = Object.fromEntries(formData);
    newObj.image = await toBase64(newObj.image);
    await (0,_modules_fetch_js__WEBPACK_IMPORTED_MODULE_3__.fetchRequest)('http://localhost:3000/api/goods/', {
      method: 'POST',
      body: {
        title: newObj.title,
        description: newObj.description,
...
const init = () => {
  const overlay = (0,_modules_modalControl_js__WEBPACK_IMPORTED_MODULE_1__.getOverlay)();
  (0,_modules_modalControl_js__WEBPACK_IMPORTED_MODULE_1__.removeOverlay)(overlay);
  const tableBody = (0,_modules_getElements_js__WEBPACK_IMPORTED_MODULE_0__.getTableBody)();
  const form = (0,_modules_modalControl_js__WEBPACK_IMPORTED_MODULE_1__.getForm)();
  (0,_modules_getElements_js__WEBPACK_IMPORTED_MODULE_0__.setTotalPrice)();
  (0,_modules_getElements_js__WEBPACK_IMPORTED_MODULE_0__.getTableRow)();
  (0,_modules_modalControl_js__WEBPACK_IMPORTED_MODULE_1__.initModal)();
  formControl(form, tableBody, _modules_modalControl_js__WEBPACK_IMPORTED_MODULE_1__.closeModal);
  renderGoods();
  editControl();
  (0,_modules_search_js__WEBPACK_IMPORTED_MODULE_5__.initSearch)();
  delControl();
};
...
/******/ })()
;
//# sourceMappingURL=main75913bc088e8235198ba.js.map